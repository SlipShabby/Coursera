...
-- TODO
CREATE OR REPLACE TEMPORARY VIEW fireCallsParquet2
USING parquet
OPTIONS (
  path "/mnt/davis/fire-calls/fire-calls-clean.parquet/"
)
...
CREATE TABLE fireCallsPartitioned2
USING DELTA
PARTITIONED BY (Priority)
AS 
  SELECT * FROM fireCallsParquet2

-- COMMAND ----------

SELECT COUNT(*) FROM fireCallsPartitioned2
